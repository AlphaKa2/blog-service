...
ADD https://github.com/elastic/apm-agent-java/releases/download/v1.5.0/elastic-apm-agent-1.5.0.jar /opt/elastic-apm-agent.jar
...
# 애플리케이션 실행
ENTRYPOINT ["java", "-javaagent:/opt/elastic-apm-agent.jar",
